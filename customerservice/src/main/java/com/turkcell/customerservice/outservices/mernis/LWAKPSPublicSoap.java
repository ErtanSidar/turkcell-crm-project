...
public class LWAKPSPublicSoap
{
    ...
    public LWAKPSPublicSoap()
    {
    }

    public LWAKPSPublicSoap(String url)
    {
        this.url=url;
    }

    public LWAKPSPublicSoap (String url,LWAConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        LWARequestResultHandler handler = new LWARequestResultHandler(LWASoapVersion.v1_1);
        return handler;
    }
